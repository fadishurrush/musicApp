export const Songs = [
  {
    url:require('../Songs/Dancin.mp3'), // Load media from the network
    title: 'Dancin',
    artist: 'Aaron Smith',
  ...
  {
    url: require('../Songs/Heroes_Tonight.mp3'), // Load media from the network
  ...
  {
    url: require('../Songs/In_My_Mind.mp3'), // Load media from the network
    title: 'In my mind',
  ...
  {
    url: require('../Songs/ты_и_я.mp3'), // Load media from the network
    title: 'ты и я',
    artist: 'Xcho',
  ...
  {
    url: require('../Songs/Эскизы.mp3'), // Load media from the network
    title: 'Эскизы',
    artist: 'Xcho',
